Public Module modVariables
    ...
    Public StrPayRefCode As String = ""
    Public frmSourceMatrix As SAPbouiCOM.Matrix
    Public strItemSelectionQuery As String = ""
    Public frmSourcePaymentform, frmApprovalWOrksheetForm As SAPbouiCOM.Form

    Public intSelectedMatrixrow As Integer = 0
    Public strFilepath As String
    Public blnAPprovalLoad As Boolean = False
    ...
    Public Const mnu_Pay_EmailSetUp As String = "mnu_Pay_EmailSetUp"
    Public Const xml_Pay_EmailSetUp As String = "frm_Pay_EmailSetUp.xml"
    Public Const frm_Pay_EmailSetUp As String = "frm_Pay_EmailSetUp"

    Public Const frm_Pay_AppHisDetails As String = "frm_Pay_AppHisDetails"
    Public Const xml_Pay_AppHisDetails As String = "frm_Pay_AppHisDetails.xml"

    Public Const xml_Pay_Approval As String = "frm_Pay_Approval.xml"
    Public Const frm_Pay_Approval As String = "frm_Pay_Approval"
    Public Const mnu_Pay_PayRA As String = "Z_mnu_PayRA"

    Public Const xml_Pay_ApproveTemp As String = "frm_Pay_AppTemp.xml"
    Public Const frm_Pay_AppTemp As String = "frm_Pay_AppTemp"
    Public Const mnu_Pay_ApproveTemp As String = "Z_Mnu_PayAppTemp"
