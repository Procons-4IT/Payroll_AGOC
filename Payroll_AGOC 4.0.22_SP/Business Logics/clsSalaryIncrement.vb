...
#Region "FormatGrid"
    Private Sub Formatgrid(ByVal agrid As SAPbouiCOM.Grid)
        ...
        agrid.Columns.Item("U_Z_ExtNo").TitleObject.Caption = "Batch No"
        agrid.Columns.Item("U_Z_ExtNo").Editable = False
    ...
    Private Function validation(ByVal aGrid As SAPbouiCOM.Grid) As Boolean
        ...
        For intInnerLoop As Integer = 0 To aGrid.DataTable.Rows.Count - 1
            ...
            If intInnerLoop > 0 Then
                If aGrid.DataTable.GetValue(3, intInnerLoop) <= aGrid.DataTable.GetValue(4, intInnerLoop - 1) Then
                    oApplication.Utilities.Message("Effective From should be Greater than Previous Effective To. Line no : " & intInnerLoop, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    aGrid.Columns.Item(3).Click(intInnerLoop, , 1)
                    Return False
                End If
            End If
