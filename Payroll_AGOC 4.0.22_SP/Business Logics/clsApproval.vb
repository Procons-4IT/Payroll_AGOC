...
#End Region
    ...
    Private Sub reDrawForm(ByVal oForm As SAPbouiCOM.Form)
        Try
            ...
            Dim intHeight As Int32 = oForm.Items.Item("9").Top ' + oForm.Items.Item("3").Height
            oForm.Items.Item("9").Top = intHeight
            oForm.Items.Item("9").Left = oForm.Width - 300
            oForm.Items.Item("9").Height = oForm.Hight / 2 - 20 ' - 300

            oForm.Items.Item("5").Left = oForm.Items.Item("5").Left '+ oForm.Items.Item("27").Width
