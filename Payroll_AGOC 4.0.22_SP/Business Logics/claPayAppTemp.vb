...
#Region "Load Form"
    ...
    Public Sub LoadForm()
        Try
            ...
            oForm = oApplication.Utilities.LoadForm(xml_Pay_ApproveTemp, frm_Pay_AppTemp)
...
#Region "Item Event"
    ...
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Pay_AppTemp Then
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.CharPressed <> 9 Then
                                    ...
                                    If pVal.ItemUID = "10" And pVal.Row > 0 And (oForm.Mode <> SAPbouiCOM.BoFormMode.fm_ADD_MODE And oForm.Mode <> SAPbouiCOM.BoFormMode.fm_FIND_MODE) Then
                                        ...
                                        If pVal.ColUID = "V_4" Or pVal.ColUID = "V_0" Then
                                    ...
                                    If pVal.ItemUID = "26" And (oForm.Mode <> SAPbouiCOM.BoFormMode.fm_ADD_MODE And oForm.Mode <> SAPbouiCOM.BoFormMode.fm_FIND_MODE) Then
                                        If ValidateApprovalTemplate(oApplication.Utilities.getEdittextvalue(oForm, "4")) = False Then
                                            oApplication.Utilities.Message("There is a pending request for this Template. You can not inactive", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                            BubbleEvent = False
                                            Exit Sub
                                        End If
                                    End If
                                    ...
                                    If pVal.ItemUID = "9" And pVal.Row > 0 And (oForm.Mode <> SAPbouiCOM.BoFormMode.fm_ADD_MODE And oForm.Mode <> SAPbouiCOM.BoFormMode.fm_FIND_MODE) Then
                                        oMatrix = oForm.Items.Item("9").Specific
                                        Me.RowtoDelete = pVal.Row
                                        intSelectedMatrixrow = pVal.Row
                                        Me.MatrixId = "9"
                                        ...
                                        If pVal.ColUID = "V_0" Then
                                            ' oCheckBox = oMatrix.Columns.Item("V_4").Cells.Item(pVal.Row).Specific
                                            ' oComboBox = oForm.Items.Item("17").Specific
                                            If ValidatePayrollCompany("R", oApplication.Utilities.getMatrixValues(oMatrix, "V_0", pVal.Row)) = False Then
                                                oApplication.Utilities.Message("There is a pending request for this Company. You can not Change", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                                BubbleEvent = False
                                                Exit Sub
                                            End If
                                        End If
...
#Region "Data Events"
    ...
    Public Sub FormDataEvent(ByRef BusinessObjectInfo As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean)
        Try
            ...
            If oForm.TypeEx = frm_Pay_AppTemp Then
                    ...
                    Case False
                        Select Case BusinessObjectInfo.EventType
                            Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_LOAD
                                oDBDataSource = oForm.DataSources.DBDataSources.Item("@Z_PAY_OAPPT")
...
#Region "Function"
    ...
    Public Function ValidateAuthorizer(ByVal DocType As String, ByVal StrDocEntry As String) As Boolean
        Try
            ...
            Select Case DocType
                ...
                Case "R"
                    strQuery = "Select ""U_Z_AppStatus"" from ""@Z_PAY_APPROVAL"" where   (""U_Z_CurApprover""='" & StrDocEntry & "' or ""U_Z_NxtApprover""='" & StrDocEntry & "') and ""U_Z_AppStatus""='P'"
            End Select
    ...
    Public Function ValidatePayrollCompany(ByVal DocType As String, ByVal StrDocEntry As String) As Boolean
        Try
            oRecordSet = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            Select Case DocType
                Case "EmpLife"
                ...
                Case "ExpCli"
                    strQuery = "Select ""U_Z_AppStatus"" from ""@Z_HR_EXPCL"" where   (""U_Z_CurApprover""='" & StrDocEntry & "' or ""U_Z_NxtApprover""='" & StrDocEntry & "') and ""U_Z_AppStatus""='P'"
                Case "R"
                    strQuery = "Select ""U_Z_AppStatus"" from ""@Z_PAY_APPROVAL"" where   (""U_Z_CompNo ""='" & StrDocEntry & "') and ""U_Z_AppStatus""='P'"
            End Select
            '   strQuery = "Select * from ""@Z_HR_APHIS"" where U_Z_ADocEntry='" & StrDocEntry & "' and U_Z_DocType='" & DocType & "'"
            oRecordSet.DoQuery(strQuery)
            If oRecordSet.RecordCount > 0 Then
    ...
    Public Function ValidateApprovalTemplate(ByVal DocType As String) As Boolean
        Try
            oRecordSet = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            Select Case DocType
                Case "EmpLife"
                ...
                Case "ExpCli"
                    strQuery = "Select ""U_Z_AppStatus"" from ""@Z_HR_EXPCL"" where   (""U_Z_CurApprover""='" & StrDocEntry & "' or ""U_Z_NxtApprover""='" & StrDocEntry & "') and ""U_Z_AppStatus""='P'"
                Case "R"
                    strQuery = "Select ""U_Z_AppStatus"" from ""@Z_PAY_APPROVAL"" where   (""Z_TempCode ""='" & DocType & "') and ""U_Z_AppStatus""='P'"
            End Select
            '   strQuery = "Select * from ""@Z_HR_APHIS"" where U_Z_ADocEntry='" & StrDocEntry & "' and U_Z_DocType='" & DocType & "'"
            oRecordSet.DoQuery(strQuery)
            If oRecordSet.RecordCount > 0 Then
        ...
        Try
            ...
            Select Case aForm.PaneLevel
                Case "1"
                    ...
                    oDBDataSourceLines_1 = oForm.DataSources.DBDataSources.Item("@Z_PAY_APPT1")
                ...
                Case "3"
                    ...
                    oDBDataSourceLines_2 = oForm.DataSources.DBDataSources.Item("@Z_PAY_APPT2")
                    oMatrix.FlushToDataSource()
...
#Region "Validations"
    Private Function validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            ...
            oRecordSet = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            strQuery = "Select ""DocEntry"" From ""@Z_PAY_OAPPT"""
            strQuery += " Where "
            ...
            For intRow As Integer = 1 To oMatrix.RowCount
                ...
                For intInnerLoop As Integer = intRow To oMatrix.RowCount
                    ...
                    If strECode = strECode1 And intRow <> intInnerLoop Then
                        oApplication.Utilities.Message("Company  Duplicated in Row : " + intInnerLoop.ToString() + "...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            ...
            oRecordSet = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            strQuery = "Select 1 As ""Return"",""DocEntry"" From ""@Z_PAY_OAPPT"""
            strQuery += " Where "
