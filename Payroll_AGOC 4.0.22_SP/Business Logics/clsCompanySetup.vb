                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "47" Then
                                    Dim strCompany As String = oApplication.Utilities.getEdittextvalue(oForm, "8")
                                    Dim ORec As SAPbobsCOM.Recordset
                                    ORec = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                                    ORec.DoQuery("SELECT *  FROM [dbo].[@Z_PAY_APPT1]  T0 WHERE T0.[U_Z_OUser] ='" & strCompany & "'")
                                    If ORec.RecordCount > 0 Then
                                        oApplication.Utilities.Message("Payroll company mapped in the approval template...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
                                End If
