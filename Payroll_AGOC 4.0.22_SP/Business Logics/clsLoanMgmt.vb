        ...
        Try
            ...
            Select Case aChoice
                Case "Emp"
                    ...
                    oGrid.Columns.Item("U_Z_ExtNo").Editable = False
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If strType <> "" Then
                ...
                If oUserTable.GetByKey(strCode) Then
                    ...
                    oUserTable.UserFields.Fields.Item("U_Z_ExtNo").Value = oGrid.DataTable.GetValue("U_Z_ExtNo", intRow)
...
#Region "Populate Employee Details"
    Private Sub PopulateEmployeeDetails(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            strQuery = "SELECT T0.[Code], T0.[Name], T0.[U_Z_EmpID],T1.U_Z_ExtNo, T0.[U_Z_LoanCode], T0.[U_Z_LoanName], T0.[U_Z_LoanAmount],  T0.[U_Z_EMIAmount], T0.[U_Z_NoEMI], T0.[U_Z_StartDate],T0.[U_Z_EndDate], T0.[U_Z_Balance], T0.[U_Z_GLACC], T0.[U_Z_Status], T0.[U_Z_DisDate] FROM [dbo].[@Z_PAY5]  T0  where T0.""U_Z_LoanCode""='" & strYear & "'"
            strQuery = "SELECT T0.[Code], T0.[Name], T1.U_Z_EmpID 'Emp',T0.[U_Z_EmpID],T1.ExtEmpNo 'U_Z_ExtNo', isnull(T1.""firstName"",'')+ isnull(T1.""middleName"",'')+ isnull(T1.""lastName"",'') 'EmpName',T0.[U_Z_LoanCode], T0.[U_Z_LoanName], T0.[U_Z_LoanAmount],  T0.[U_Z_EMIAmount], T0.[U_Z_NoEMI],T0.[U_Z_DisDate], T0.[U_Z_StartDate], T0.[U_Z_EndDate], T0.[U_Z_PaidEMI], T0.[U_Z_Balance], T0.[U_Z_GLACC], T0.[U_Z_Status] FROM [dbo].[@Z_PAY5]  T0  inner Join OHEM T1 on T1.empID=T0.U_Z_EmpID  where T0.""U_Z_LoanCode""='" & strYear & "' and T1.""U_Z_CompNo""='" & strCompany & "' "
    ...
    Private Sub TransactionDetails(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            stryear = oCombobox.Selected.Value
            oGrid = aform.Items.Item("18").Specific
            strQuery = "SELECT T0.[Code], T0.[Name], T1.ExtEmpNo 'U_Z_ExtNo',T1.U_Z_EmpID 'Emp', T0.[U_Z_EmpID], isnull(T1.""firstName"",'')+ '  ' + isnull(T1.""middleName"",'')+ '  ' + isnull(T1.""lastName"",'') 'EmpName', T0.[U_Z_LoanCode], T0.[U_Z_LoanName], T0.[U_Z_LoanAmount],T0.[U_Z_DisDate], T0.[U_Z_StartDate], T0.[U_Z_NoEMI], T0.[U_Z_EMIAmount], T0.[U_Z_EndDate], T0.[U_Z_PaidEMI], T0.[U_Z_Balance], T0.[U_Z_GLACC], T0.[U_Z_Status] FROM [dbo].[@Z_PAY5]  T0  inner Join OHEM T1 on T1.empID=T0.U_Z_EmpID  where T0.""U_Z_LoanCode""='" & stryear & "' and T1.U_Z_CompNo='" & strCompany & "'"
                                            ...
                                            For introw1 As Integer = 0 To oDataTable.Rows.Count - 1
                                                If introw1 = 0 Then
                                                    ...
                                                    Try
                                                        ...
                                                        oGrid.DataTable.SetValue("U_Z_ExtNo", pVal.Row, oDataTable.GetValue("ExtEmpNo", introw1))
                                                        oGrid.DataTable.SetValue(pVal.ColUID, pVal.Row, val)
                                                    Catch ex As Exception
                                                    End Try
                                                Else
                                                    ...
                                                    Try
                                                        ...
                                                        oGrid.DataTable.SetValue("U_Z_ExtNo", oGrid.DataTable.Rows.Count - 1, oDataTable.GetValue("ExtEmpNo", introw1))
