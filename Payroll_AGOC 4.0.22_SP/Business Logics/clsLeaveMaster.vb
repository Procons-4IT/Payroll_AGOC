...
#Region "Databind"
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            dtTemp.ExecuteQuery("SELECT T0.[Code], T0.[Name], T0.[U_Z_FrgnName],T0.[U_Z_DedRate], T0.[U_Z_PaidLeave], T0.[U_Z_DaysYear], T0.[U_Z_NoofDays], T0.[U_Z_Accured], T0.[U_Z_Prorate],T0.[U_Z_EntHR],T0.[U_Z_Cutoff], T0.[U_Z_EOS], T0.[U_Z_Basic],T0.[U_Z_EntAft], T0.[U_Z_TimesTaken], T0.[U_Z_MaxDays], T0.[U_Z_DailyRate], T0.[U_Z_LifeTime],T0.[U_Z_StopProces], T0.[U_Z_BalCheck],T0.[U_Z_GLACC], T0.[U_Z_GLACC1], T0.[U_Z_OffCycle], T0.[U_Z_OB], T0.[U_Z_SickLeave] FROM [dbo].[@Z_PAY_LEAVE]  T0 order by Code")
...
#Region "FormatGrid"
    Private Sub Formatgrid(ByVal agrid As SAPbouiCOM.Grid)
        ...
        agrid.Columns.Item("U_Z_EntHR").Type = SAPbouiCOM.BoGridColumnType.gct_CheckBox
        agrid.Columns.Item("U_Z_EntHR").TitleObject.Caption = "Entitled from HR"
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If oGrid.DataTable.GetValue(0, intRow) <> "" Or oGrid.DataTable.GetValue(1, intRow) <> "" Then
                ...
                If oUserTable.GetByKey(strCode) = False Then
                    ...
                    OCHECKBOXCOLUMN = oGrid.Columns.Item("U_Z_EntHR")
                    If OCHECKBOXCOLUMN.IsChecked(intRow) Then
                        oUserTable.UserFields.Fields.Item("U_Z_EntHR").Value = "Y"
                    Else
                        oUserTable.UserFields.Fields.Item("U_Z_EntHR").Value = "N"
                    End If
