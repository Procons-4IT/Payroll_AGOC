...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddFields("Z_EMPFAMILY", "Z_CivilID", "Civil ID Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            ...
            addField("@Z_PAY_LEAVE", "Z_Prorate", "Prorated", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            addField("@Z_PAY_LEAVE", "Z_EntHR", "Entitlement from HR", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")


            'Payroll Approval - Tables

            addField("@Z_OADM", "Z_IsApp", "Approval Required", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")


            AddTables("Z_PAY_OAPPT", "Approval Template", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddTables("Z_PAY_APPT2", "Approval Authorizer", SAPbobsCOM.BoUTBTableType.bott_DocumentLines)
            AddTables("Z_PAY_APPT1", "Approval Orginator", SAPbobsCOM.BoUTBTableType.bott_DocumentLines)

            AddFields("Z_PAY_OAPPT", "Z_Code", "Approval Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_OAPPT", "Z_Name", "Approval Description", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_PAY_OAPPT", "Z_DocType", "Document Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_OAPPT", "Z_DocDesc", "Document Description", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_PAY_OAPPT", "Z_Active", "Active Template", SAPbobsCOM.BoFieldTypes.db_Alpha, , 1)

            AddFields("Z_PAY_APPT1", "Z_OUser", "Orginator Id", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_APPT1", "Z_OName", "Orginator Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)

            AddFields("Z_PAY_APPT2", "Z_AUser", "Authorizer Id", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_APPT2", "Z_AName", "Authorizer Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_PAY_APPT2", "Z_AMan", "Mandatory", SAPbobsCOM.BoFieldTypes.db_Alpha, , 1)
            AddFields("Z_PAY_APPT2", "Z_AFinal", "Final Stage", SAPbobsCOM.BoFieldTypes.db_Alpha, , 1)

            AddTables("Z_PAY_APHIS", "Approval History", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddFields("Z_PAY_APHIS", "Z_DocEntry", "Document Entry", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_APHIS", "Z_DocType", "Document Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_APHIS", "Z_EmpId", "Employee Id", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_APHIS", "Z_EmpName", "Employee Name", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            addField("@Z_PAY_APHIS", "Z_AppStatus", "Approved Status", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "P,A,R", "Pending,Approved,Rejected", "P")
            AddFields("Z_PAY_APHIS", "Z_Remarks", "Comments", SAPbobsCOM.BoFieldTypes.db_Memo)
            AddFields("Z_PAY_APHIS", "Z_ApproveBy", "Approved By", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_APHIS", "Z_Approvedt", "Approver Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_PAY_APHIS", "Z_ADocEntry", "Template DocEntry", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_PAY_APHIS", "Z_ALineId", "Template LineId", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_PAY_APHIS", "Z_YEAR", "Year", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_PAY_APHIS", "Z_MONTH", "Month", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_PAY_APHIS", "Z_CompNo", "Company Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("Z_PAY_APHIS", "Z_Attachment", "File Name", SAPbobsCOM.BoFieldTypes.db_Memo)
            AddFields("Z_PAY_APHIS", "Z_NextApprover", "Next Approver", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)

            addField("@Z_PAYROLL", "Z_AppStatus", "Approved Status", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "P,A,R", "Pending,Approved,Rejected", "P")

            AddTables("Z_PAY_Approval", "Payroll Approval", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_PAY_Approval", "Z_YEAR", "Year", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_PAY_Approval", "Z_MONTH", "Month", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_PAY_Approval", "Z_RefCode", "Payroll Reference", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_Approval", "Z_CompNo", "Company Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            addField("@Z_PAY_Approval", "Z_AppStatus", "Approved Status", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "P,A,R", "Pending,Approved,Rejected", "P")
            AddFields("Z_PAY_Approval", "Z_Remarks", "Comments", SAPbobsCOM.BoFieldTypes.db_Memo)
            AddFields("Z_PAY_Approval", "Z_CurApprover", "Current Approver", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_Approval", "Z_NxtApprover", "Next Approver", SAPbobsCOM.BoFieldTypes.db_Alpha, , 40)
            AddFields("Z_PAY_Approval", "Z_AppReqDate", "Required Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_PAY_Approval", "Z_DocType", "Document Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_Approval", "Z_Creater", "Creater", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_PAY_Approval", "Z_FileName", "Attachment", SAPbobsCOM.BoFieldTypes.db_Memo)
            AddFields("Z_PAY_Approval", "Z_AppID", "Approval Template ID", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_PAY_Approval", "Z_TempCode", "Approval Template Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)


            '  addField("@Z_OADM", "Z_IsApp", "Approval Required", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")

            'New Fields in Payroll1 - AGOC 
            AddFields("Z_PAYROLL1", "Z_Country", "Country", SAPbobsCOM.BoFieldTypes.db_Alpha, , 100)
            AddFields("Z_PAYROLL1", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_TRANS", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_OLETRANS", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_OLETRANS_OFF", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY5", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY20", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_OLADJTRANS", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY_TKTTRANS", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_PAY11", "Z_ExtNo", "Batch No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
    ...
    Public Sub CreateUDO()
        Try
            AddUDO("Z_PAY_APHIS", "Approval History", "Z_PAY_APHIS", "DocEntry", "U_Z_DocEntry", , , , SAPbobsCOM.BoUDOObjType.boud_Document)
            ...
            'Approval tempalte
            AddUDO("Z_PAY_OAPPT", "Approval Template", "Z_PAY_OAPPT", "DocEntry", "U_Z_Code", "Z_PAY_APPT1", "Z_PAY_APPT2", , SAPbobsCOM.BoUDOObjType.boud_Document)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
